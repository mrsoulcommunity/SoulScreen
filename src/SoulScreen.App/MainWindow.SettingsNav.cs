...
public partial class MainWindow
{
    ...
    private static readonly Dictionary<string, (string Title, string Glyph, string Brush, string Keywords)> SectionLooks = new()
    {
        ...
        ["SCREENSHOTS AND RECORDINGS"] = ("Captures", "\uE8B9", "NavIndigo", "screenshot recording capture folder budget storage ocr text search"),
        ["RECURRING RECORDING"] = ("Recurring recording", "\uE823", "NavOrange", "schedule automatic recording weekday weekend timer security recurring cron"),
        ...
        ["UPDATES"] = ("Updates", "\uEB52", "NavCyan", "update version release download install upgrade github"),
